...
import com.example.mohsen.adapter.AdapterPrint
import com.example.mohsen.databinding.Fragment4Binding
...
class FragmentFour : Fragment() {
    ...
    private val itemAdapter: AdapterPrint by lazy { AdapterPrint(items, requireContext()) }
    ...
    private fun loadItemsFromSharedPreferences() {
        val sharedPreferences = requireContext().getSharedPreferences("Print", 0)
        ...
        for (i in 0 until jsonArray.length()) {
            ...
            items.add(Item(text1, text2, "Print"))
        }
