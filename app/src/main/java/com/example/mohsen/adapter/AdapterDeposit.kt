...
class AdapterDeposit (private val items3 : MutableList<Item>, private val context: Context) : RecyclerView.Adapter<AdapterDeposit.ItemsViewHolder>(){
    ...
    private fun removeItemFromSharedPreferences(item: Item) {
        val sharedPreferences = context.getSharedPreferences("Deposit", 0)
